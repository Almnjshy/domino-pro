...
export const ResultScreen: React.FC<ResultScreenProps> = ({
  gameState, onNewRound, onMainMenu
}) => {
  ...
  useEffect(() => {
    titleOpacity.value = withTiming(1, { duration: 600, delay: 200 });
        ...
        <View style={styles.resultsList}>
          {results.sorted.map((player, idx) => (
            <View key={player.id} style={[
              styles.playerRow,
              player.id === gameState.winnerId && styles.winnerRow
            ]}>
              <View style={[styles.rankBadge, {
                backgroundColor: idx === 0 ? '#ffd700' : idx === 1 ? '#c0c0c0' : idx === 2 ? '#cd7f32' : '#888'
              }]}>
...
const styles = StyleSheet.create({
  ...
  title: {
    ...
    textShadowColor: 'rgba(0,0,0,0.5)', textShadowOffset: { width: 2, height: 2 },
    textShadowRadius: 8, marginBottom: 4,
  },
  subtitle: { color: 'rgba(255,255,255,0.6)', fontSize: 16, marginBottom: 20, letterSpacing: 2 },
  winnerCard: {
    width: 280, backgroundColor: 'rgba(20,20,20,0.95)', borderRadius: 24,
    padding: 24, alignItems: 'center', borderWidth: 2, borderColor: '#d4af37',
    shadowColor: '#ffd700', shadowOffset: { width: 0, height: 0 },
    shadowOpacity: 0.6, shadowRadius: 20, elevation: 15, marginBottom: 24,
  },
  ...
  scoreBox: {
    backgroundColor: 'rgba(212,175,55,0.15)', borderRadius: 16,
  ...
  playerRow: {
    ...
    padding: 12, marginBottom: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)',
  },
  ...
  primaryBtn: {
    backgroundColor: '#d4af37', paddingVertical: 16, borderRadius: 16, alignItems: 'center',
  ...
  secondaryBtn: {
    ...
    borderRadius: 16, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.2)',
  },
